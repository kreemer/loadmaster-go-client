...
func TestClient_AddSubVirtualService(t *testing.T) {
	testCases := []struct {
		...
		{"success response", `{"code": 200, "message": "OK", "status": "success"}`, 200, &ShowSubVirtualServiceResponse{LoadMasterResponse: &LoadMasterResponse{Code: 200, Message: "OK", Status: "success"}}, false},
