...
func TestClient_ListCertificate(t *testing.T) {
	testCases := []struct {
		...
		{"success response", `{"code": 200, "message": "OK", "status": "success", "cert": [ { "name": "Example", "type": "RSA", "modulus": "EXAMPLE" } ]}`, 200, &ListCertResponse{LoadMasterResponse: &LoadMasterResponse{Code: 200, Message: "OK", Status: "success"}, Cert: []CertInfo{{Name: "Example", Type: "RSA", Modulus: "EXAMPLE"}}}, false},
